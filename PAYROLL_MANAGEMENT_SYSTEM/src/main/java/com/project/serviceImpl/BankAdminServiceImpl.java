...
public class BankAdminServiceImpl implements BankAdminService {
    ...
    private final BankRepo bankRepo; //  Inject BankRepo

    @Autowired
    private RoleRepo roleRepo; // Make sure you have this repository

    @Override
    public BankAdmin createBankAdmin(BankAdmin admin) {
        // Fetch the bank if provided
        ...
        // Assign ROLE_BANK_ADMIN to the associated User
        if (admin.getUser() != null) {
            admin.getUser().setRole("ROLE_BANK_ADMIN");
        }
